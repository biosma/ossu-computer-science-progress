...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        base = 32
        total_chars = 95
        shifted = (ord(char) - base + shift) % total_chars
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        total_chars = 95
        for i in range(len(self.get_text())):
            decrypt_message += chr(((ord(self.get_text()[i]) - base - pad[i]) % total_chars) + base)
        return PlaintextMessage(decrypt_message, pad)

#TESTS
# m1 = Message('Hello!')
# print(m1)
# p1 = PlaintextMessage('Hello!', [5, 10, 2, 3, 0, 2])
# print(p1.get_ciphertext())
# e1 = EncryptedMessage('05<Nvv`\\.8_0qvh?b?')
# print(e1.decrypt_message([59, 44, 50, 90, 86, 13, 13, 60, 64, 46, 70, 74, 45, 86, 5, 93, 15, 57]))

# print(p1.get_pad())
# print(p1.change_pad([6, 11, 3, 4, 1, 3]))
# print(p1.get_pad())
