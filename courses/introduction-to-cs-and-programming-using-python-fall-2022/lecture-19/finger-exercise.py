...
# Think of a stack of pancakes. As you make pancakes, you create a stack of them with older pancakes going on the bottom and newer pancakes on the top. 
...
print('s list' ,s.myList)

print('s removal',s.remove())
print('s list' ,s.myList)